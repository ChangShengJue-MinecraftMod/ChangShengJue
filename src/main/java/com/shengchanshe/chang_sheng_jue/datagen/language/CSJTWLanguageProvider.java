    ...
    public class CSJTWLanguageProvider extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add(ChangShengJueItems.SIDE_FASTENING_LEATHER_HELMET.get(),"絳帕");
            this.add(ChangShengJueItems.SIDE_FASTENING_LEATHER_CHESTPLATE.get(),"側襟皮甲");
            this.add(ChangShengJueItems.SIDE_FASTENING_LEATHER_LEGGINGS.get(),"小口褲");
            this.add(ChangShengJueItems.SIDE_FASTENING_LEATHER_BOOTS.get(),"方口翹尖履");

            this.add(ChangShengJueItems.OUTER_ROBE_HELMET.get(),"蟬腹巾");
            ...
            this.add(ChangShengJueBlocks.GRE_CYLINDER_TILE_BLOCK.get(),"灰色琉璃瓦塊");
            this.add(ChangShengJueBlocks.RED_CYLINDER_TILE_BLOCK.get(),"紅色琉璃瓦塊");
            this.add(ChangShengJueBlocks.BLACK_CYLINDER_TILE_BLOCK.get(),"黑色琉璃瓦塊");
            ...
            this.add(ChangShengJueBlocks.GRE_CYLINDER_TILE_SLAB.get(),"灰色琉璃瓦半磚");
            this.add(ChangShengJueBlocks.RED_CYLINDER_TILE_SLAB.get(),"紅色琉璃瓦半磚");
            this.add(ChangShengJueBlocks.BLACK_CYLINDER_TILE_SLAB.get(),"黑色琉璃瓦半磚");
            ...
            this.add(ChangShengJueBlocks.PURPLE_CYLINDER_TILE_SLAB.get(),"紫色琉璃瓦半磚");

            this.add(ChangShengJueBlocks.GRE_CYLINDER_TILE_SIDE.get(),"灰色側向琉璃瓦");
            this.add(ChangShengJueBlocks.RED_CYLINDER_TILE_SIDE.get(),"紅色側向琉璃瓦");
            this.add(ChangShengJueBlocks.BLACK_CYLINDER_TILE_SIDE.get(),"黑色側向琉璃瓦");
            ...
            this.add(ChangShengJueBlocks.BLACK_DOUBLE_CYLINDER_TILE.get(),"黑色雙層琉璃瓦");
            ...
            this.add(ChangShengJueBlocks.GRE_EAVES_CYLINDER_TILE.get(),"灰色飛簷琉璃瓦");
            this.add(ChangShengJueBlocks.RED_EAVES_CYLINDER_TILE.get(),"紅色飛簷琉璃瓦");
            this.add(ChangShengJueBlocks.BLACK_EAVES_CYLINDER_TILE.get(),"黑色飛簷琉璃瓦");
            ...
            this.add(ChangShengJueBlocks.PURPLE_HIPPED_ROOF.get(), "蓝色攢尖");
            ...
            this.add(ChangShengJueBlocks.GRE_DOUBLE_CYLINDER_TILE_SIDE.get(), "灰色側向雙層琉璃瓦");
            this.add(ChangShengJueBlocks.RED_DOUBLE_CYLINDER_TILE_SIDE.get(), "紅色側向雙層琉璃瓦");
            this.add(ChangShengJueBlocks.BLACK_DOUBLE_CYLINDER_TILE_SIDE.get(), "黑色側向雙層琉璃瓦");
            ...
            this.add(ChangShengJueBlocks.BIRCH_PILLAR.get(), "白樺木燈架柱子");
            this.add(ChangShengJueBlocks.JUNGLE_PILLAR.get(), "叢林木燈架柱子");
            this.add(ChangShengJueBlocks.CRIMSON_PILLAR.get(), "緋紅木燈架柱子");
            this.add(ChangShengJueBlocks.WARPED_PILLAR.get(), "詭異木燈架柱子");
            this.add(ChangShengJueBlocks.MANGROVE_PILLAR.get(), "紅樹燈架柱子");
            this.add(ChangShengJueBlocks.HUANG_HUA_LI_PILLAR.get(), "黃花梨燈架柱子");
            this.add(ChangShengJueBlocks.WENGE_PILLAR.get(), "雞翅木燈架柱子");
            this.add(ChangShengJueBlocks.ACACIA_PILLAR.get(), "金合歡燈架柱子");
            this.add(ChangShengJueBlocks.DARK_OAK_PILLAR.get(), "深色橡木燈架柱子");
            this.add(ChangShengJueBlocks.OAK_PILLAR.get(), "橡木燈架柱子");
            this.add(ChangShengJueBlocks.CHERRY_PILLAR.get(), "櫻花木燈架柱子");
            this.add(ChangShengJueBlocks.SPRUCE_PILLAR.get(), "雲杉木燈架柱子");
            this.add(ChangShengJueBlocks.ZI_TAN_PILLAR.get(), "紫檀木燈架柱子");
            ...
            this.add("config."+ ChangShengJue.MOD_ID +".enable_bandit_spawn", "是否允許生成土匪。");
            this.add("config."+ ChangShengJue.MOD_ID +".enable_villain_spawn", "是否允許生成惡人。");
            ...
            this.add("config."+ ChangShengJue.MOD_ID +".tread_the_snow_without_trace_max_level", "踏雪無痕最大等級上限");
            this.add("config."+ ChangShengJue.MOD_ID +".tread_the_snow_without_trace_max_exp", "踏雪無痕突破所需的成功釋放次數");
            this.add("config."+ ChangShengJue.MOD_ID +".tread_the_snow_without_trace_max_cooldown", "踏雪無痕最大冷卻時間");
            ...
            this.add("gui."+ ChangShengJue.MOD_ID +".plaque.write", "寫下");
            this.add("gui."+ ChangShengJue.MOD_ID +".plaque.placeholder", "寫下文字……");
