...
//        this.add(ChangShengJueEffects.GOLDEN_BELL_JAR_EFFECT.get(), "Golden Bell Jar");
        ...
        this.add(ChangShengJue.MOD_ID +".xiake.forge_block", "Forge furnace");
        this.add(ChangShengJue.MOD_ID +".xiake.forge_block.page1.text", "Forge furnace Crafting Recipe");
        this.add(ChangShengJue.MOD_ID +".xiake.forge_block.page2.text", "Used for crafting weapons, armor, etc. View selected items within the forge interface. Crafting automatically consumes required materials from your inventory.");
        ...
        this.add(ChangShengJue.MOD_ID +".xiake.tailoring_case", "Tailoring Bench");
        this.add(ChangShengJue.MOD_ID +".xiake.tailoring_case.page1.text", "Tailoring Bench Crafting Recipe");
        this.add(ChangShengJue.MOD_ID +".xiake.tailoring_case.page2.text", "Used for crafting clothing (armor). View selected items within the bench interface. Crafting automatically consumes required materials from your inventory.");
