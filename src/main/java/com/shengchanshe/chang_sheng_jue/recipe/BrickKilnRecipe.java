...
public class BrickKilnRecipe implements Recipe<SimpleContainer> {
    ...
    public BrickKilnRecipe(ResourceLocation id, ItemStack result, NonNullList<Ingredient> ingredients, String group) {
    ...
    public static BrickKilnRecipe create(ResourceLocation id, ItemStack result,
                                         NonNullList<Ingredient> ingredients, String group) {
        return new BrickKilnRecipe(id, result, ingredients, group);
    }

    public static class Type implements RecipeType<BrickKilnRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "brick_kiln";

        private Type() {}
    }

    public static class Serializer implements RecipeSerializer<BrickKilnRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(ChangShengJue.MOD_ID, "brick_kiln");
        ...
        @Override
        public @NotNull BrickKilnRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
            ...
            return new BrickKilnRecipe(recipeId, result, ingredients, group);
        }

        @Override
        public BrickKilnRecipe fromNetwork(@NotNull ResourceLocation recipeId, @NotNull FriendlyByteBuf buffer) {
        ...
        @Override
        public void toNetwork(@NotNull FriendlyByteBuf buffer, BrickKilnRecipe recipe) {
