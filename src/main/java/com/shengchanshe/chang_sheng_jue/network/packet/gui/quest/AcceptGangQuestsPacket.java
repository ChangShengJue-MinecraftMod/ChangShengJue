    ...
    public void handle(Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            if (player != null && questId != null) {
                AbstractGangLeader abstractGangLeader = GangQuestPacketGuard.validateAccept(player);
                if (abstractGangLeader != null
                        && QuestManager.getInstance().tryAcceptQuest(player, abstractGangLeader, questId)) {
