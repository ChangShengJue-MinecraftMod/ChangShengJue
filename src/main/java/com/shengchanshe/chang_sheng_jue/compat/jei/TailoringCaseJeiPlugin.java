...
@JeiPlugin
public class TailoringCaseJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        var recipes = recipeManager.getAllRecipesFor(TailoringCaseRecipe.Type.INSTANCE);
        ...
        for (var recipe : recipes) {
            try {
                ...
                registration.addIngredientInfo(
                        ...
                        Component.translatable("jei."+ ChangShengJue.MOD_ID +".tailoring_case.usage")
                );
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ResourceLocation benchId = new ResourceLocation(ChangShengJue.MOD_ID, "tailoring_case");
        ...
        var tailoringCase = RecipeType.create(
                ChangShengJue.MOD_ID,
                "tailoring_case",
                TailoringCaseRecipe.class
        );

        registration.addRecipeCatalyst(stack, tailoringCase);
    }
}
