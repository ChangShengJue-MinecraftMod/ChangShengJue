package com.shengchanshe.changshengjue.item.combat.tiers;
...
public enum ChangShengJueArmorMaterials implements StringRepresentable, ArmorMaterial {
    COTTON("leather", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (enumMap) -> {
    ...
    SILK("leather", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (enumMap) -> {
        enumMap.put(ArmorItem.Type.BOOTS, 1);
    ...
    SILK_1("leather", 5, Util.make(new EnumMap<>(ArmorItem.Type.class), (enumMap) -> {
