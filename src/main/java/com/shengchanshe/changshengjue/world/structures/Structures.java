...
//     */
//    public static ConfiguredStructureFeature<?, ?> CONFIGURED_THIEFDEN = Registration.SI_HE_YUAN.get()
...
//        Registry.register(BuiltinRegistries.CONFIGURED_STRUCTURE_FEATURE, new ResourceLocation(ChangShengJue.MOD_ID, "si_he_yuan"),
//                CONFIGURED_THIEFDEN);
//    }
//
//    /**
...
//                        1145147877),  // the seed of the structure so no two structures always spawn over each-other. Make this large and unique
//                true);
//    }
//
//    /**
...
//                portalFeature = CONFIGURED_THIEFDEN;
//            }
//
...
//            new MobSpawnSettings.SpawnerData(ChangShengJueEntity.CHANG_SHENG_JUE_VILLAGER.get(), 200, 3, 6),
//            new MobSpawnSettings.SpawnerData(ChangShengJueEntity.CHANG_SHENG_JUE_HUNTER.get(), 200, 1, 2)
//    ));
//    public static void setupStructureSpawns(final StructureSpawnListGatherEvent event) {
//            event.addEntitySpawns(MobCategory.MISC, STRUCTURE_MONSTERS.get());
//    }
//}