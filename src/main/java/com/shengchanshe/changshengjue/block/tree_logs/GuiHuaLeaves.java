...
public class GuiHuaLeaves extends LeavesBlock {
    public GuiHuaLeaves(Properties p_54422_) {
        super(p_54422_);
    }
    ...
    public void animateTick(BlockState pState, Level pLevel, BlockPos pPos, RandomSource pRandom) {
        ...
        if (pRandom.nextInt(30) == 0) {
            ...
            if (!isFaceFull(blockstate.getCollisionShape(pLevel, blockpos), Direction.UP)) {
                ParticleUtils.spawnParticleBelow(pLevel, pPos, pRandom, ChangShengJueParticles.GUI_HUA_DEFOLIATION_PARTICLE.get());
            }
        }
    }
