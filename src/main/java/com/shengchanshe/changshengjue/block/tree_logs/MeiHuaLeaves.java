...
public class MeiHuaLeaves extends LeavesBlock {
    public MeiHuaLeaves(Properties p_54422_) {
        super(p_54422_);
    }
    ...
    public void animateTick(BlockState pState, Level pLevel, BlockPos pPos, RandomSource pRandom) {
        ...
        if (pRandom.nextInt(30) == 0) {
            ...
            if (!isFaceFull(blockstate.getCollisionShape(pLevel, blockpos), Direction.UP)) {
                ParticleUtils.spawnParticleBelow(pLevel, pPos, pRandom, ChangShengJueParticles.MEI_HUA_DEFOLIATION_PARTICLE.get());
            }
        }
    }
        ...
        if (!pLevel.isClientSide()) {
            ...
            if (pRandom.nextInt(10) == 0) {
                ...
                if (groundPos != null) {
                    ...
                    if (currentLeafState.is(ChangShengJueBlocks.MEI_HUA_DEFOLIATION.get())) {
                        ...
                        pLevel.setBlock(groundPos, ChangShengJueBlocks.MEI_HUA_DEFOLIATION.get().defaultBlockState(), 3);
                    }else if (pLevel.isEmptyBlock(leafPos)) {
                        pLevel.setBlock(leafPos, ChangShengJueBlocks.MEI_HUA_DEFOLIATION.get().defaultBlockState(), 3);
                    }
                }
            }
        }
