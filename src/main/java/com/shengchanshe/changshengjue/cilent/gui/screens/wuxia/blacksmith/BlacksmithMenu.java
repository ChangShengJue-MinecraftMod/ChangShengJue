...
public class BlacksmithMenu extends AbstractContainerMenu {
    ...
    public BlacksmithMenu(int id, Inventory inventory) {
        this(id, inventory, new ClientSideMerchant(inventory.player));
    }

    public BlacksmithMenu(int id, Inventory inventory, Merchant merchant) {
        super(ChangShengJueMenuTypes.BLACKSMITH_MENU.get(), id);
