...
public class Tiger extends Animal implements GeoEntity {
    ...
    protected void registerGoals(){
        ...
        this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(this, Animal.class, 15, true, false, (entity) -> !(entity instanceof Tiger)));
        this.targetSelector.addGoal(4, new NearestAttackableTargetGoal<>(this, Mob.class, 15,true, false, (entity) -> entity instanceof Enemy && !(entity instanceof Creeper) && !(entity instanceof Tiger)));
    }
