...
public class SwordGangLeaderRenderer extends DynamicGeoEntityRenderer<SwordGangLeader> {
    ...
    protected final ResourceLocation CAPE_TEXTURE = new ResourceLocation(ChangShengJue.MOD_ID, "textures/entity/gang_leader/sword_gang_leader.png");
    protected ItemStack mainHandItem;
    protected ItemStack offhandItem;

    public SwordGangLeaderRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SwordGangLeaderModel());
        this.addRenderLayer(new BlockAndItemGeoLayer<>(this) {
            ...
            protected ItemStack getStackForBone(GeoBone bone, SwordGangLeader animatable) {
                ...
                switch (bone.getName()) {
                    ...
                    case "bipedHandRight" -> var10000 = animatable.isLeftHanded() ? SwordGangLeaderRenderer.this.offhandItem : SwordGangLeaderRenderer.this.mainHandItem;
            ...
            protected ItemDisplayContext getTransformTypeForStack(GeoBone bone, ItemStack stack, SwordGangLeader animatable) {
            ...
            protected void renderStackForBone(PoseStack poseStack, GeoBone bone, ItemStack stack, SwordGangLeader animatable, MultiBufferSource bufferSource, float partialTick, int packedLight, int packedOverlay) {
                if (stack == SwordGangLeaderRenderer.this.mainHandItem) {
                    poseStack.mulPose(Axis.XP.rotationDegrees(-90.0F));
                    if (stack.getItem() instanceof ShieldItem) {
                        poseStack.translate(0.0, 0.125, -0.25);
                    }
                } else if (stack == SwordGangLeaderRenderer.this.offhandItem) {
                    poseStack.mulPose(Axis.XP.rotationDegrees(-90.0F));
                    if (stack.getItem() instanceof ShieldItem) {
                        poseStack.translate(0.0, 0.125, 0.25);
