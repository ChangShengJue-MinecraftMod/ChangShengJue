...
public class FemalePeacockEntity extends AbstractPeacockEntity {
    public float flap;
    ...
    public FemalePeacockEntity(EntityType<? extends FemalePeacockEntity> p_27557_, Level p_27558_) {
    ...
    public boolean canMate(Animal animal) {
        if (animal == this) {
            return false;
        } else if (!(animal instanceof MalePeacockEntity)) {
            return false;
        }else {
            return true;
        }
