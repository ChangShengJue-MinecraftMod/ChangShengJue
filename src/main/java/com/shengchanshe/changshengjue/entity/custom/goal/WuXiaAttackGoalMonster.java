package com.shengchanshe.changshengjue.entity.custom.goal;
...
public class WuXiaAttackGoalMonster extends MeleeAttackGoal {
    public AbstractWuXiaMonster wuxia;
    private int attackDelay = 10;//攻击延迟
    private int ticksUntilNextAttack = 10;//直到下一次攻击计时
    private boolean shouldCountTillNextAttack = false;
    public WuXiaAttackGoalMonster(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen) {
        super(pMob, pSpeedModifier, pFollowingTargetEvenIfNotSeen);
        wuxia = (AbstractWuXiaMonster)pMob;
    }
