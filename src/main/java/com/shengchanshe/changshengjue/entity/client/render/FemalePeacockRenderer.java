...
import com.shengchanshe.changshengjue.entity.client.model.FemalePeacockModel;
...
public class FemalePeacockRenderer extends GeoEntityRenderer<FemalePeacockEntity> {
    ...
    //获取纹理位置
    @Override
    public ResourceLocation getTextureLocation(FemalePeacockEntity instance) {
        return new ResourceLocation(ChangShengJue.MOD_ID,"textures/entity/female_peacock_entity.png");
    }

    //获取渲染类型
    @Override
    public void render(FemalePeacockEntity entity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        if (entity.isBaby()){
