...
import com.shengchanshe.changshengjue.entity.client.model.CraneModel;
...
public class CraneRenderer extends GeoEntityRenderer<CraneEntity> {
    ...
    //获取纹理位置
    @Override
    public ResourceLocation getTextureLocation(CraneEntity instance) {
        return new ResourceLocation(ChangShengJue.MOD_ID,"textures/entity/crane_entity.png");
    }

    //获取渲染类型
    @Override
    public void render(CraneEntity entity, float entityYaw, float partialTick,
