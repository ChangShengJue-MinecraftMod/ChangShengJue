package com.shengchanshe.changshengjue.entity.client.render.combat.throwingknives;
...
public class ThrowingKnivesEntityEntityRender extends EntityRenderer<ThrowingKnivesEntity> {
    ...
    public ThrowingKnivesEntityEntityRender(EntityRendererProvider.Context pContext) {
        super(pContext);
