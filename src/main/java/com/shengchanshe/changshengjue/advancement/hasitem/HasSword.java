...
public class HasSword extends SimpleCriterionTrigger<HasSword.TriggerInstance> {
    ...
    // 创建触发器实例，用于反序列化
    public HasSword.TriggerInstance createInstance(JsonObject json, ContextAwarePredicate predicate, DeserializationContext context) {
        return new HasSword.TriggerInstance(predicate);
    }
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance {
        ...
        public static HasSword.TriggerInstance createInstance() {
            return new HasSword.TriggerInstance(ContextAwarePredicate.ANY);
        }
